## For japanese learners looking to better their japanese!

Install needed npm modules using "npm i" to be able to run the back end (Will be changed to python later).

Start the app using "npm start" then go to [local](http://localhost:3000/) on your browser to see the website.
